...
function serializeURL(url, options, NET_CONFIG) {
  ...
  var base = _is["default"].Object(options) && options.hasOwnProperty('base') ? options.base : NET_CONFIG.base;
  ...
  var params = _is["default"].Object(options) && options.hasOwnProperty('params') ? options.params : NET_CONFIG.params;
  if (_is["default"].String(params)) {
    params = params.trim();
  } else if (_is["default"].NotEmptyObject(params)) {
